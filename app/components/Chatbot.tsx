  ...
  const [messages, setMessages] = useState([
    {
      ...
      quickReplies: ["Book Consultation", "Emergency Help", "Service Info", "Call Now"],
    },
  ])
        ...
        <div className="fixed bottom-24 right-6 w-80 bg-white rounded-xl shadow-2xl z-50 border">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-100">Online • Quick Response</p>
                </div>
              </div>
          ...
          <div className="p-4 border-t">
            ...
            <div className="flex justify-between mt-2">
              <button className="text-xs text-blue-600 hover:underline">📞 Call Now</button>
              <button className="text-xs text-blue-600 hover:underline">📅 Book Meeting</button>
            </div>
          </div>
        </div>
      )}
